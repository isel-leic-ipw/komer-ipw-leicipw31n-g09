...
const users = [
    { id: 1, name: "user1", password:"123456", authToken: '0b115b6e-8fcd-4b66-ac26-33392dcb9340'},
    { id: 2, name: "user2", password:"123456", authToken: '3dfd8596-cfd3-431d-8e36-f0fc4c64f364'}
]
...
export default function () {
    ...
    async function createUser(user) {
        const newUser = { id: nextUserId++, name: user.name,description: user.description , authToken: crypto.randomUUID() }
        users.push(newUser)
